...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        var isTouchDevice = navigator.userAgent.match(/(iphone|android|iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/);
        var isTouch = (('ontouchstart' in window) || (navigator.msMaxTouchPoints > 0) || (navigator.maxTouchPoints));
        var container = $(this);
        var headerHeight = $('.header').height();
        var windowsHeight = isTouchDevice ? $window.height() - headerHeight : $window.height();
        ...
        */
        function prepareDom(){
            ...
            var headerHeight = $('.header').height();
            windowsHeight = isTouchDevice ? $window.height() - headerHeight : $window.height();
